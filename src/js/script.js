...
const reflectPreference = () => {
  ...
  document
    .querySelector("#switchColorScheme")
...
const topicSVGs = {
  html: `<svg width="266px" height="266px" viewBox="0 0 24 24">
      <path fill="#F15C2A"
  ...
  css: `<svg width="256px" height="256px" viewBox="0 0 32 32" version="1.1">
      <path fill="#1774BB"
  ...
  js: `<svg width="256px" height="256px" viewBox="-4 -4 58 58">
      <path fill="#FCB041"
